 ...
 */
! function(t, r) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = r() : "function" == typeof define && define.amd ? define(r) : (t = t || self).VueQrcode = r()
}(this, function() {
    "use strict";
    ...
    var t, o = (function(t, r) {
        t.exports = function i(a, u, f) {
            function s(e, t) {
                if (!u[e]) {
                    if (!a[e]) {
                        var r = c;
            ...
            for (var h = c, t = 0; t < f.length; t++) s(f[t]);
            return s
        }({
            1: [function(t, r, e) {
                r.exports = function() {
            ...
            2: [function(t, r, a) {
                var u = t("./utils").getSymbolSize;
                a.getRowColCoords = function(t) {
                    if (1 === t) return [];
                    for (var r = Math.floor(t / 7) + 2, e = u(t), n = 145 === e ? 26 : 2 * Math.ceil((e - 13) / (2 * r - 2)), o = [e - 7], i = 1; i < r - 1; i++) o[i] = o[i - 1] - n;
                    return o.push(6), o.reverse()
                }, a.getPositions = function(t) {
                    for (var r = [], e = a.getRowColCoords(t), n = e.length, o = 0; o < n; o++)
                        for (var i = 0; i < n; i++) 0 === o && 0 === i || 0 === o && i === n - 1 || o === n - 1 && 0 === i || r.push([e[o], e[i]]);
                    return r
                }
            }, {
                "./utils": 21
            ...
            10: [function(t, r, e) {
                ...
                e.getEncodedBits = function(t, r) {
                    for (var e = t.bit << 3 | r, n = e << 10; 0 <= o.getBCHDigit(n) - i;) n ^= 1335 << o.getBCHDigit(n) - i;
                    return 21522 ^ (e << 10 | n)
                }
            }, {
                "./utils": 21
                ...
                i.getBitsLength = function(t) {
                    ...
                    for (r = 0; r < this.data.length; r++) {
                        ...
                        if (33088 <= e && e <= 40956) e -= 33088;
                            ...
                            if (!(57408 <= e && e <= 60351)) throw new Error("Invalid SJIS character: " + this.data[r] + "\nMake sure your charset is UTF-8");
                            e -= 49472
                        }
            ...
            13: [function(t, r, u) {
                ...
                u.isValid = function(t) {
                    ...
                    for (var r = t.size, e = 0, n = 0, o = 0, i = null, a = null, u = 0; u < r; u++) {
                        n = o = 0, i = a = null;
                        for (var f = 0; f < r; f++) {
                            var s = t.get(u, f);
                            s === i ? n++ : (5 <= n && (e += h.N1 + (n - 5)), i = s, n = 1), (s = t.get(f, u)) === a ? o++ : (5 <= o && (e += h.N1 + (o - 5)), a = s, o = 1)
                        }
                        5 <= n && (e += h.N1 + (n - 5)), 5 <= o && (e += h.N1 + (o - 5))
                    }
                    return e
                    ...
                    for (var r = t.size, e = 0, n = 0, o = 0, i = 0; i < r; i++) {
                        n = o = 0;
                        for (var a = 0; a < r; a++) n = n << 1 & 2047 | t.get(i, a), 10 <= a && (1488 === n || 93 === n) && e++, o = o << 1 & 2047 | t.get(a, i), 10 <= a && (1488 === o || 93 === o) && e++
                    }
                    return e * h.N3
                }, u.getPenaltyN4 = function(t) {
                    for (var r = 0, e = t.data.length, n = 0; n < e; n++) r += t.data[n];
                    var o = Math.abs(Math.ceil(100 * r / e / 5) - 10);
                    return o * h.N4
                }, u.applyMask = function(t, r) {
                    for (var e = r.size, n = 0; n < e; n++)
                        for (var o = 0; o < e; o++) r.isReserved(o, n) || r.xor(o, n, i(t, o, n))
                }, u.getBestMask = function(t, r) {
                    for (var e = Object.keys(u.Patterns).length, n = 0, o = 1 / 0, i = 0; i < e; i++) {
                        r(i), u.applyMask(i, t);
            ...
            16: [function(t, r, n) {
                var a = t("../utils/buffer"),
                    u = t("./galois-field");
                n.mul = function(t, r) {
                    for (var e = a.alloc(t.length + r.length - 1), n = 0; n < t.length; n++)
                        for (var o = 0; o < r.length; o++) e[n + o] ^= u.mul(t[n], r[o]);
                    return e
                }, n.mod = function(t, r) {
                    for (var e = a.from(t); 0 <= e.length - r.length;) {
                        for (var n = e[0], o = 0; o < r.length; o++) e[o] ^= u.mul(r[o], n);
                        for (var i = 0; i < e.length && 0 === e[i];) i++;
                        e = e.slice(i)
                    }
                    return e
                }, n.generateECPolynomial = function(t) {
                    for (var r = a.from([1]), e = 0; e < t; e++) r = n.mul(r, [1, u.exp(e)]);
                    return r
                }
            }, {
                "../utils/buffer": 28,
            ...
            17: [function(t, r, e) {
                var T = t("../utils/buffer"),
                    R = t("./utils"),
                    i = t("./error-correction-level"),
                    s = t("./bit-buffer"),
                    c = t("./bit-matrix"),
                    l = t("./alignment-pattern"),
                    g = t("./finder-pattern"),
                    p = t("./mask-pattern"),
                    C = t("./error-correction-code"),
                    I = t("./reed-solomon-encoder"),
                    d = t("./version"),
                    u = t("./format-info"),
                    h = t("./mode"),
                    y = t("./segments"),
                ...
                function m(r, t, e) {
                    ...
                    e.forEach(function(t) {
                        n.put(t.mode.bit, 4), n.put(t.getLength(), h.getCharCountIndicator(t.mode, r)), t.write(n)
                    });
                    var o = R.getSymbolTotalCodewords(r),
                        i = C.getTotalCodewordsCount(r, t),
                        a = 8 * (o - i);
                    for (n.getLengthInBits() + 4 <= a && n.put(0, 4); n.getLengthInBits() % 8 != 0;) n.putBit(0);
                    for (var u = (a - n.getLengthInBits()) / 8, f = 0; f < u; f++) n.put(f % 2 ? 17 : 236, 8);
                    return function(t, r, e) {
                        for (var n = R.getSymbolTotalCodewords(r), o = C.getTotalCodewordsCount(r, e), i = n - o, a = C.getBlocksCount(r, e), u = a - n % a, f = Math.floor(n / a), s = Math.floor(i / a), h = s + 1, c = f - s, l = new I(c), g = 0, p = new Array(a), d = new Array(a), y = 0, v = T.from(t.buffer), w = 0; w < a; w++) {
                            var m = w < u ? s : h;
                            p[w] = v.slice(g, g + m), d[w] = l.encode(p[w]), g += m, y = Math.max(y, m)
                        }
                        var b, E, A = T.alloc(n),
                            B = 0;
                        for (b = 0; b < y; b++)
                            for (E = 0; E < a; E++) b < p[E].length && (A[B++] = p[E][b]);
                        for (b = 0; b < c; b++)
                            for (E = 0; E < a; E++) A[B++] = d[E][b];
                        return A
                    }(n, r, t)
                }
                ...
                function a(t, r, e, n) {
                    var o;
                    if (v(t)) o = y.fromArray(t);
                    else {
                        if ("string" != typeof t) throw new Error("Invalid data");
                        var i = r;
                        if (!i) {
                            var a = y.rawSplit(t);
                            i = d.getBestVersionForData(a, e)
                        }
                        o = y.fromString(t, i || 40)
                    }
                    var u = d.getBestVersionForData(o, e);
                    if (!u) throw new Error("The amount of data is too big to be stored in a QR Code");
                    if (r) {
                        if (r < u) throw new Error("\nThe chosen QR Code version cannot contain this amount of data.\nMinimum version required to store current data is: " + u + ".\n")
                    } else r = u;
                    var f = m(r, e, o),
                        s = R.getSymbolSize(r),
                        h = new c(s);
                    return function(t, r) {
                            for (var e = t.size, n = g.getPositions(r), o = 0; o < n.length; o++)
                                for (var i = n[o][0], a = n[o][1], u = -1; u <= 7; u++)
                                    if (!(i + u <= -1 || e <= i + u))
                                        for (var f = -1; f <= 7; f++) a + f <= -1 || e <= a + f || (0 <= u && u <= 6 && (0 === f || 6 === f) || 0 <= f && f <= 6 && (0 === u || 6 === u) || 2 <= u && u <= 4 && 2 <= f && f <= 4 ? t.set(i + u, a + f, !0, !0) : t.set(i + u, a + f, !1, !0))
                        }(h, r),
                        function(t) {
                        ...
                        function(t, r) {
                            for (var e = l.getPositions(r), n = 0; n < e.length; n++)
                                for (var o = e[n][0], i = e[n][1], a = -2; a <= 2; a++)
                                    for (var u = -2; u <= 2; u++) - 2 === a || 2 === a || -2 === u || 2 === u || 0 === a && 0 === u ? t.set(o + a, i + u, !0, !0) : t.set(o + a, i + u, !1, !0)
                        }(h, r), w(h, e, 0), 7 <= r && function(t, r) {
                            for (var e, n, o, i = t.size, a = d.getEncodedBits(r), u = 0; u < 18; u++) e = Math.floor(u / 3), n = u % 3 + i - 8 - 3, o = 1 == (a >> u & 1), t.set(e, n, o, !0), t.set(n, e, o, !0)
                        }(h, r),
                        function(t, r) {
                            for (var e = t.size, n = -1, o = e - 1, i = 7, a = 0, u = e - 1; 0 < u; u -= 2)
                                for (6 === u && u--;;) {
                                    for (var f = 0; f < 2; f++)
                                        if (!t.isReserved(o, u - f)) {
                                            var s = !1;
                                            a < r.length && (s = 1 == (r[a] >>> i & 1)), t.set(o, u - f, s), -1 === --i && (a++, i = 7)
                                        } if ((o += n) < 0 || e <= o) {
                                        o -= n, n = -n;
                                        break
                                    }
                                }
                        }(h, f), isNaN(n) && (n = p.getBestMask(h, w.bind(null, h, e))), p.applyMask(n, h), w(h, e, n), {
                            modules: h,
                            version: r,
                ...
                e.create = function(t, r) {
                    ...
                    var e, n, o = i.M;
                    return void 0 !== r && (o = i.from(r.errorCorrectionLevel, i.M), e = d.from(r.version), n = p.from(r.maskPattern), r.toSJISFunc && R.setToSJISFunction(r.toSJISFunc)), a(t, e, o, n)
                }
            }, {
                "../utils/buffer": 28,
                "./alignment-pattern": 2,
            ...
            18: [function(t, r, e) {
                ...
                n.prototype.initialize = function(t) {
                    this.degree = t, this.genPoly = u.generateECPolynomial(this.degree)
                }, n.prototype.encode = function(t) {
                    if (!this.genPoly) throw new Error("Encoder not initialized");
                    var r = a.alloc(this.degree),
                        e = f.concat([t, r], t.length + this.degree),
                        n = u.mod(e, this.genPoly),
                        o = this.degree - n.length;
                    if (0 < o) {
                        var i = a.alloc(this.degree);
                        return n.copy(i, o), i
                    }
                    return n
                }, r.exports = n
            ...
            19: [function(t, r, e) {
                ...
                e.KANJI = new RegExp(n, "g"), e.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), e.BYTE = new RegExp(o, "g"), e.NUMERIC = new RegExp("[0-9]+", "g"), e.ALPHANUMERIC = new RegExp("[A-Z $%*+\\-./:]+", "g");
                var i = new RegExp("^" + n + "$"),
                    a = new RegExp("^[0-9]+$"),
                    u = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
            ...
            20: [function(t, r, f) {
                ...
                function d(t) {
                    var r, e, n = p(s.NUMERIC, g.NUMERIC, t),
                        o = p(s.ALPHANUMERIC, g.ALPHANUMERIC, t);
                    e = h.isKanjiModeEnabled() ? (r = p(s.BYTE, g.BYTE, t), p(s.KANJI, g.KANJI, t)) : (r = p(s.BYTE_KANJI, g.BYTE, t), []);
                    var i = n.concat(o, r, e);
                ...
                function e(t, r) {
                    var e, n = g.getBestModeForData(t);
                    if ((e = g.from(r, n)) !== g.BYTE && e.bit < n.bit) throw new Error('"' + t + '" cannot be encoded with mode ' + g.toString(e) + ".\n Suggested mode is: " + g.toString(n));
                    switch (e !== g.KANJI || h.isKanjiModeEnabled() || (e = g.BYTE), e) {
                        case g.NUMERIC:
                            return new o(t);
                        case g.ALPHANUMERIC:
                            return new i(t);
                ...
                f.fromArray = function(t) {
                    return t.reduce(function(t, r) {
                        return "string" == typeof r ? t.push(e(r, null)) : r.data && t.push(e(r.data, r.mode)), t
                    }, [])
                }, f.fromString = function(t, r) {
                    for (var e = d(t, h.isKanjiModeEnabled()), n = function(t) {
                            ...
                            for (var e = {}, n = {
                                ...
                                for (var a = t[i], u = [], f = 0; f < a.length; f++) {
                                    var s = a[f],
                                        h = "" + i + f;
                                    u.push(h), e[h] = {
                                        node: s,
                                    ...
                                    for (var c = 0; c < o.length; c++) {
                                        var l = o[c];
                                        e[l] && e[l].node.mode === s.mode ? (n[l][h] = y(e[l].lastCount + s.length, s.mode) - y(e[l].lastCount, s.mode), e[l].lastCount += s.length) : (e[l] && (e[l].lastCount = s.length), n[l][h] = y(s.length, s.mode) + 4 + g.getCharCountIndicator(s.mode, r))
                                    }
                                }
                                o = u
                            }
                        ...
                        }(n, r), i = c.find_path(o.map, "start", "end"), a = [], u = 1; u < i.length - 1; u++) a.push(o.table[i[u]].node);
                    return f.fromArray(function(t) {
                        return t.reduce(function(t, r) {
                            var e = 0 <= t.length - 1 ? t[t.length - 1] : null;
                            return e && e.mode === r.mode ? t[t.length - 1].data += r.data : t.push(r), t
                        }, [])
                    }(a))
                }, f.rawSplit = function(t) {
                    return f.fromArray(d(t, h.isKanjiModeEnabled()))
                }
            }, {
                "./alphanumeric-data": 3,
                "./byte-data": 6,
            ...
            23: [function(t, r, o) {
                ...
                o.from = function(t, r) {
                    return h.isValid(t) ? parseInt(t, 10) : r
                }, o.getCapacity = function(t, r, e) {
                    if (!h.isValid(t)) throw new Error("Invalid QR Code version");
                    void 0 === e && (e = s.BYTE);
                    var n = u.getSymbolTotalCodewords(t),
                        o = f.getTotalCodewordsCount(t, r),
                        i = 8 * (n - o);
                    if (e === s.MIXED) return i;
                    var a = i - c(e, t);
                    switch (e) {
                        case s.NUMERIC:
                    ...
                    if (a(t)) {
                        if (1 < t.length) return function(t, r) {
                            for (var e = 1; e <= 40; e++) {
                                if (l(t, e) <= o.getCapacity(e, r, s.MIXED)) return e
                            }
                            return
                        }(t, n);
                    ...
                    return function(t, r, e) {
                        for (var n = 1; n <= 40; n++)
                            if (r <= o.getCapacity(n, e, t)) return n;
                        return
                    }(e.mode, e.getLength(), n)
                }, o.getEncodedBits = function(t) {
                    if (!h.isValid(t) || t < 7) throw new Error("Invalid QR Code version");
                    for (var r = t << 12; 0 <= u.getBCHDigit(r) - e;) r ^= 7973 << u.getBCHDigit(r) - e;
                    return t << 12 | r
                }
            }, {
                "./error-correction-code": 7,
            ...
            24: [function(t, r, e) {
                var s = t("./can-promise"),
                    h = t("./core/qrcode"),
                    n = t("./renderer/canvas"),
                    o = t("./renderer/svg-tag.js");

                function i(n, o, i, a, r) {
                    var t = [].slice.call(arguments, 1),
                        e = t.length,
                        u = "function" == typeof t[e - 1];
                    if (!u && !s()) throw new Error("Callback required as last argument");
                    if (!u) {
                        if (e < 1) throw new Error("Too few arguments provided");
                        return 1 === e ? (i = o, o = a = void 0) : 2 !== e || o.getContext || (a = i, i = o, o = void 0), new Promise(function(t, r) {
                            try {
                                var e = h.create(i, a);
                                t(n(e, o, a))
                            } catch (t) {
                    ...
                    2 === e ? (r = i, i = o, o = a = void 0) : 3 === e && (o.getContext && void 0 === r ? (r = a, a = void 0) : (r = a, a = i, i = o, o = void 0));
                    try {
                        var f = h.create(i, a);
                        r(null, n(f, o, a))
                    } catch (t) {
                ...
                e.create = h.create, e.toCanvas = i.bind(null, n.render), e.toDataURL = i.bind(null, n.renderToDataURL), e.toString = i.bind(null, function(t, r, e) {
                    return o.render(t, e)
                })
            }, {
                "./can-promise": 1,
            ...
            25: [function(t, r, u) {
                ...
                u.render = function(t, r, e) {
                    ...
                    var i = f.getImageWidth(t.modules.size, n),
                        a = o.getContext("2d"),
                        u = a.createImageData(i, i);
                    return f.qrToImageData(u.data, t, n),
                        function(t, r, e) {
                            t.clearRect(0, 0, r.width, r.height), r.style || (r.style = {});
                            r.height = e, r.width = e, r.style.height = e + "px", r.style.width = e + "px"
                        }(a, o, i), a.putImageData(u, 0, 0), o
                }, u.renderToDataURL = function(t, r, e) {
                    var n = e;
                    void 0 !== n || r && r.getContext || (n = r, r = void 0), n = n || {};
                    var o = u.render(t, r, n),
                        i = n.type || "image/png",
                        a = n.rendererOpts || {};
            ...
            26: [function(t, r, e) {
                ...
                e.render = function(t, r, e) {
                    var n = l.getOptions(r),
                        ...
                        i = t.modules.data,
                        a = o + 2 * n.margin,
                        u = n.color.light.a ? "<path " + g(n.color.light, "fill") + ' d="M0 0h' + a + "v" + a + 'H0z"/>' : "",
                        f = "<path " + g(n.color.dark, "stroke") + ' d="' + function(t, r, e) {
                            for (var n = "", o = 0, i = !1, a = 0, u = 0; u < t.length; u++) {
                                var f = Math.floor(u % r),
                                    s = Math.floor(u / r);
                                f || i || (i = !0), t[u] ? (a++, 0 < u && 0 < f && t[u - 1] || (n += i ? p("M", f + e, .5 + s + e) : p("m", o, 0), o = 0, i = !1), f + 1 < r && t[u + 1] || (n += p("h", a), a = 0)) : o++
                            }
                            return n
                        }(i, o, n.margin) + '"/>',
                        s = 'viewBox="0 0 ' + a + " " + a + '"',
                        h = n.width ? 'width="' + n.width + '" height="' + n.width + '" ' : "",
                        c = '<svg xmlns="http://www.w3.org/2000/svg" ' + h + s + ' shape-rendering="crispEdges">' + u + f + "</svg>\n";
            ...
            27: [function(t, r, d) {
                function o(t) {
                    ...
                    if (r.length < 3 || 5 === r.length || 8 < r.length) throw new Error("Invalid hex color: " + t);
                ...
                }, d.getScale = function(t, r) {
                    return r.width && r.width >= t + 2 * r.margin ? r.width / (t + 2 * r.margin) : r.scale
                }, d.getImageWidth = function(t, r) {
                    var e = d.getScale(t, r);
                    return Math.floor((t + 2 * r.margin) * e)
                }, d.qrToImageData = function(t, r, e) {
                    for (var n = r.modules.size, o = r.modules.data, i = d.getScale(n, e), a = Math.floor((n + 2 * e.margin) * i), u = e.margin * i, f = [e.color.light, e.color.dark], s = 0; s < a; s++)
                        for (var h = 0; h < a; h++) {
                            var c = 4 * (s * a + h),
                                l = e.color.light;
                            if (u <= s && u <= h && s < a - u && h < a - u) {
                                var g = Math.floor((s - u) / i),
                                    p = Math.floor((h - u) / i);
                                l = f[o[g * n + p] ? 1 : 0]
                            }
            ...
            28: [function(t, r, e) {
                ...
                function u(t, r, e) {
                    return u.TYPED_ARRAY_SUPPORT || this instanceof u ? "number" == typeof t ? s(this, t) : function(t, r, e, n) {
                        if ("number" == typeof r) throw new TypeError('"value" argument must not be a number');
                        if ("undefined" != typeof ArrayBuffer && r instanceof ArrayBuffer) return function(t, r, e, n) {
                            ...
                            u.TYPED_ARRAY_SUPPORT ? o.__proto__ = u.prototype : o = h(t, o);
                            return o
                        }(t, r, e, n);
                ...
                function f(t, r) {
                    var e;
                    return u.TYPED_ARRAY_SUPPORT ? (e = new Uint8Array(r)).__proto__ = u.prototype : (null === (e = t) && (e = new u(r)), e.length = r), e
                }

                function s(t, r) {
                    var e = f(t, r < 0 ? 0 : 0 | i(r));
                ...
                function h(t, r) {
                    for (var e = r.length < 0 ? 0 : 0 | i(r.length), n = f(t, e), o = 0; o < e; o += 1) n[o] = 255 & r[o];
                    return n
                }
                ...
                function o(t, r) {
                    ...
                    for (var n = t.length, o = null, i = [], a = 0; a < n; ++a) {
                        if (55295 < (e = t.charCodeAt(a)) && e < 57344) {
                            if (!o) {
                                if (56319 < e) {
                            ...
                            if (e < 56320) {
                                -1 < (r -= 3) && i.push(239, 191, 189), o = e;
                                continue
                            }
                            e = 65536 + (o - 55296 << 10 | e - 56320)
                        } else o && -1 < (r -= 3) && i.push(239, 191, 189);
                        if (o = null, e < 128) {
                            if (--r < 0) break;
                            i.push(e)
                        } else if (e < 2048) {
                ...
                u.TYPED_ARRAY_SUPPORT && (u.prototype.__proto__ = Uint8Array.prototype, u.__proto__ = Uint8Array, "undefined" != typeof Symbol && Symbol.species && u[Symbol.species] === u && Object.defineProperty(u, Symbol.species, {
                    ...
                    enumerable: !1,
                    writable: !1
                })), u.prototype.write = function(t, r, e) {
                    void 0 === r || void 0 === e && "string" == typeof r ? (e = this.length, r = 0) : isFinite(r) && (r |= 0, isFinite(e) ? e |= 0 : e = void 0);
                    var n = this.length - r;
                    if ((void 0 === e || n < e) && (e = n), 0 < t.length && (e < 0 || r < 0) || r > this.length) throw new RangeError("Attempt to write outside buffer bounds");
                    return function(t, r, e, n) {
                        return l(o(r, t.length - e), t, e, n)
                    }(this, t, r, e)
                }, u.prototype.slice = function(t, r) {
                    var e, n = this.length;
                    if ((t = ~~t) < 0 ? (t += n) < 0 && (t = 0) : n < t && (t = n), (r = void 0 === r ? n : ~~r) < 0 ? (r += n) < 0 && (r = 0) : n < r && (r = n), r < t && (r = t), u.TYPED_ARRAY_SUPPORT)(e = this.subarray(t, r)).__proto__ = u.prototype;
                    else {
                        var o = r - t;
                        e = new u(o, void 0);
                    ...
                    if (e <= r) return this;
                    var o;
                    if (r >>>= 0, e = void 0 === e ? this.length : e >>> 0, "number" == typeof(t = t || 0))
                        for (o = r; o < e; ++o) this[o] = t;
                    else {
                        var i = u.isBuffer(t) ? t : new u(t),
                            a = i.length;
                        for (o = 0; o < e - r; ++o) this[o + r] = i[o % a]
                    }
                    return this
            ...
            29: [function(t, r, e) {
                e.byteLength = function(t) {
                    ...
                    var r, e, n = c(t),
                        o = n[0],
                        i = n[1],
                        a = new h(function(t, r) {
                            return 3 * (t + r) / 4 - r
                        }(o, i)),
                        u = 0,
                        f = 0 < i ? o - 4 : o;
                    for (e = 0; e < f; e += 4) r = s[t.charCodeAt(e)] << 18 | s[t.charCodeAt(e + 1)] << 12 | s[t.charCodeAt(e + 2)] << 6 | s[t.charCodeAt(e + 3)], a[u++] = r >> 16 & 255, a[u++] = r >> 8 & 255, a[u++] = 255 & r;
                    2 === i && (r = s[t.charCodeAt(e)] << 2 | s[t.charCodeAt(e + 1)] >> 4, a[u++] = 255 & r);
                    1 === i && (r = s[t.charCodeAt(e)] << 10 | s[t.charCodeAt(e + 1)] << 4 | s[t.charCodeAt(e + 2)] >> 2, a[u++] = r >> 8 & 255, a[u++] = 255 & r);
                    return a
                }, e.fromByteArray = function(t) {
                    for (var r, e = t.length, n = e % 3, o = [], i = 0, a = e - n; i < a; i += 16383) o.push(f(t, i, a < i + 16383 ? a : i + 16383));
                    1 == n ? (r = t[e - 1], o.push(u[r >> 2] + u[r << 4 & 63] + "==")) : 2 == n && (r = (t[e - 2] << 8) + t[e - 1], o.push(u[r >> 10] + u[r >> 4 & 63] + u[r << 2 & 63] + "="));
                    return o.join("")
                };
                for (var u = [], s = [], h = "undefined" != typeof Uint8Array ? Uint8Array : Array, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = 0, i = n.length; o < i; ++o) u[o] = n[o], s[n.charCodeAt(o)] = o;
                ...
                function f(t, r, e) {
                    for (var n, o, i = [], a = r; a < e; a += 3) n = (t[a] << 16 & 16711680) + (t[a + 1] << 8 & 65280) + (255 & t[a + 2]), i.push(u[(o = n) >> 18 & 63] + u[o >> 12 & 63] + u[o >> 6 & 63] + u[63 & o]);
                    return i.join("")
                }
            ...
            30: [function(t, r, e) {
                ...
                function u(t) {
                    if (a < t) throw new RangeError('The value "' + t + '" is invalid for option "size"');
                    var r = new Uint8Array(t);
                    return Object.setPrototypeOf(r, c.prototype), r
                }

                function c(t, r, e) {
                    if ("number" != typeof t) return f(t, r, e);
                ...
                function f(t, r, e) {
                    ...
                    if (O(t, ArrayBuffer) || t && O(t.buffer, ArrayBuffer)) return function(t, r, e) {
                    ...
                    if (null != n && n !== t) return c.from(n, r, e);
                    var o = function(t) {
                        if (c.isBuffer(t)) {
                            var r = 0 | g(t.length),
                                e = u(r);
                        ...
                        if (void 0 !== t.length) return "number" != typeof t.length || j(t.length) ? u(0) : l(t);
                        if ("Buffer" === t.type && Array.isArray(t.data)) return l(t.data)
                    }(t);
                    if (o) return o;
                    if ("undefined" != typeof Symbol && null != Symbol.toPrimitive && "function" == typeof t[Symbol.toPrimitive]) return c.from(t[Symbol.toPrimitive]("string"), r, e);
                ...
                function h(t) {
                    return s(t), u(t < 0 ? 0 : 0 | g(t))
                }

                function l(t) {
                    for (var r = t.length < 0 ? 0 : 0 | g(t.length), e = u(r), n = 0; n < r; n += 1) e[n] = 255 & t[n];
                    return e
                }

                function g(t) {
                    if (a <= t) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + a.toString(16) + " bytes");
                    return 0 | t
                }
                ...
                function y(t, r, e, n, o) {
                    if (0 === t.length) return -1;
                    if ("string" == typeof e ? (n = e, e = 0) : 2147483647 < e ? e = 2147483647 : e < -2147483648 && (e = -2147483648), j(e = +e) && (e = o ? 0 : t.length - 1), e < 0 && (e = t.length + e), e >= t.length) {
                        if (o) return -1;
                        e = t.length - 1
                    } else if (e < 0) {
                        if (!o) return -1;
                    ...
                    if ("string" == typeof r && (r = c.from(r, n)), c.isBuffer(r)) return 0 === r.length ? -1 : v(t, r, e, n, o);
                    if ("number" == typeof r) return r &= 255, "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(t, r, e) : Uint8Array.prototype.lastIndexOf.call(t, r, e) : v(t, [r], e, n, o);
                ...
                function E(t, r, e) {
                    ...
                    for (var n = [], o = r; o < e;) {
                        var i, a, u, f, s = t[o],
                            h = null,
                            c = 239 < s ? 4 : 223 < s ? 3 : 191 < s ? 2 : 1;
                        if (o + c <= e) switch (c) {
                            case 1:
                                s < 128 && (h = s);
                                break;
                            case 2:
                                128 == (192 & (i = t[o + 1])) && 127 < (f = (31 & s) << 6 | 63 & i) && (h = f);
                                break;
                            case 3:
                                i = t[o + 1], a = t[o + 2], 128 == (192 & i) && 128 == (192 & a) && 2047 < (f = (15 & s) << 12 | (63 & i) << 6 | 63 & a) && (f < 55296 || 57343 < f) && (h = f);
                                break;
                            case 4:
                                i = t[o + 1], a = t[o + 2], u = t[o + 3], 128 == (192 & i) && 128 == (192 & a) && 128 == (192 & u) && 65535 < (f = (15 & s) << 18 | (63 & i) << 12 | (63 & a) << 6 | 63 & u) && f < 1114112 && (h = f)
                        }
                        null === h ? (h = 65533, c = 1) : 65535 < h && (h -= 65536, n.push(h >>> 10 & 1023 | 55296), h = 56320 | 1023 & h), n.push(h), o += c
                    }
                    return function(t) {
                        var r = t.length;
                        if (r <= A) return String.fromCharCode.apply(String, t);
                        var e = "",
                            n = 0;
                        for (; n < r;) e += String.fromCharCode.apply(String, t.slice(n, n += A));
                        return e
                    }(n)
                }
                e.kMaxLength = a, (c.TYPED_ARRAY_SUPPORT = function() {
                    ...
                    return f(t, r, e)
                }, Object.setPrototypeOf(c.prototype, Uint8Array.prototype), Object.setPrototypeOf(c, Uint8Array), c.alloc = function(t, r, e) {
                    return function(t, r, e) {
                        if (s(t), t <= 0) return u(t);
                        return void 0 === r ? u(t) : "string" == typeof e ? u(t).fill(r, e) : u(t).fill(r)
                    }(t, r, e)
                    ...
                    if (O(t, Uint8Array) && (t = c.from(t, t.offset, t.byteLength)), O(r, Uint8Array) && (r = c.from(r, r.offset, r.byteLength)), !c.isBuffer(t) || !c.isBuffer(r)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
                    if (t === r) return 0;
                    ...
                    for (e = 0; e < t.length; ++e) {
                        var i = t[e];
                        if (O(i, Uint8Array) && (i = c.from(i)), !c.isBuffer(i)) throw new TypeError('"list" argument must be an Array of Buffers');
                        i.copy(n, o), o += i.length
                    }
                    return n
                    ...
                    var t = this.length;
                    return 0 === t ? "" : 0 === arguments.length ? E(this, 0, t) : function(t, r, e) {
                        var n = !1;
                        (void 0 === r || r < 0) && (r = 0);
                ...
                }, o && (c.prototype[o] = c.prototype.inspect), c.prototype.compare = function(t, r, e, n, o) {
                    if (O(t, Uint8Array) && (t = c.from(t, t.offset, t.byteLength)), !c.isBuffer(t)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t);
                    ...
                    for (var i = o - n, a = e - r, u = Math.min(i, a), f = this.slice(n, o), s = t.slice(r, e), h = 0; h < u; ++h)
                        if (f[h] !== s[h]) {
                            i = f[h], a = s[h];
                            break
                    ...
                    var o = this.length - r;
                    if ((void 0 === e || o < e) && (e = o), 0 < t.length && (e < 0 || r < 0) || r > this.length) throw new RangeError("Attempt to write outside buffer bounds");
                    n = n || "utf8";
                    for (var i, a, u, f, s, h, c, l, g, p = !1;;) switch (n) {
                        case "hex":
                            return w(this, t, r, e);
                        case "utf8":
                        case "utf-8":
                            return l = r, g = e, k(x(t, (c = this).length - l), c, l, g);
                        case "ascii":
                            return m(this, t, r, e);
                        case "latin1":
                        case "binary":
                            return m(this, t, r, e);
                        case "base64":
                            return f = this, s = r, h = e, k(_(t), f, s, h);
                        case "ucs2":
                        case "ucs-2":
                        case "utf16le":
                        case "utf-16le":
                            return a = r, u = e, k(L(t, (i = this).length - a), i, a, u);
                        default:
                ...
                function P(t, r, e, n, o, i) {
                    ...
                    if (o < r || r < i) throw new RangeError('"value" argument is out of bounds');
                ...
                function N(t, r, e, n, o) {
                    return r = +r, e >>>= 0, o || M(t, r, e, 4), i.write(t, r, e, n, 23, 4), e + 4
                }

                function U(t, r, e, n, o) {
                    return r = +r, e >>>= 0, o || M(t, r, e, 8), i.write(t, r, e, n, 52, 8), e + 8
                }
                c.prototype.slice = function(t, r) {
                    ...
                    t >>>= 0, r >>>= 0, e || I(t, r, this.length);
                    for (var n = this[t + --r], o = 1; 0 < r && (o *= 256);) n += this[t + --r] * o;
                    return n
                }, c.prototype.readUInt8 = function(t, r) {
                    return t >>>= 0, r || I(t, 1, this.length), this[t]
                }, c.prototype.readUInt16LE = function(t, r) {
                    return t >>>= 0, r || I(t, 2, this.length), this[t] | this[t + 1] << 8
                }, c.prototype.readUInt16BE = function(t, r) {
                    return t >>>= 0, r || I(t, 2, this.length), this[t] << 8 | this[t + 1]
                }, c.prototype.readUInt32LE = function(t, r) {
                    return t >>>= 0, r || I(t, 4, this.length), (this[t] | this[t + 1] << 8 | this[t + 2] << 16) + 16777216 * this[t + 3]
                }, c.prototype.readUInt32BE = function(t, r) {
                    return t >>>= 0, r || I(t, 4, this.length), 16777216 * this[t] + (this[t + 1] << 16 | this[t + 2] << 8 | this[t + 3])
                }, c.prototype.readIntLE = function(t, r, e) {
                    t >>>= 0, r >>>= 0, e || I(t, r, this.length);
                    for (var n = this[t], o = 1, i = 0; ++i < r && (o *= 256);) n += this[t + i] * o;
                    return (o *= 128) <= n && (n -= Math.pow(2, 8 * r)), n
                }, c.prototype.readIntBE = function(t, r, e) {
                    t >>>= 0, r >>>= 0, e || I(t, r, this.length);
                    for (var n = r, o = 1, i = this[t + --n]; 0 < n && (o *= 256);) i += this[t + --n] * o;
                    return (o *= 128) <= i && (i -= Math.pow(2, 8 * r)), i
                }, c.prototype.readInt8 = function(t, r) {
                    return t >>>= 0, r || I(t, 1, this.length), 128 & this[t] ? -1 * (255 - this[t] + 1) : this[t]
                }, c.prototype.readInt16LE = function(t, r) {
                    t >>>= 0, r || I(t, 2, this.length);
                    ...
                    return t >>>= 0, r || I(t, 4, this.length), this[t] | this[t + 1] << 8 | this[t + 2] << 16 | this[t + 3] << 24
                }, c.prototype.readInt32BE = function(t, r) {
                    return t >>>= 0, r || I(t, 4, this.length), this[t] << 24 | this[t + 1] << 16 | this[t + 2] << 8 | this[t + 3]
                }, c.prototype.readFloatLE = function(t, r) {
                    return t >>>= 0, r || I(t, 4, this.length), i.read(this, t, !0, 23, 4)
                }, c.prototype.readFloatBE = function(t, r) {
                    return t >>>= 0, r || I(t, 4, this.length), i.read(this, t, !1, 23, 4)
                }, c.prototype.readDoubleLE = function(t, r) {
                    return t >>>= 0, r || I(t, 8, this.length), i.read(this, t, !0, 52, 8)
                }, c.prototype.readDoubleBE = function(t, r) {
                    return t >>>= 0, r || I(t, 8, this.length), i.read(this, t, !1, 52, 8)
                    ...
                    var i = 1,
                        a = 0;
                    for (this[r] = 255 & t; ++a < e && (i *= 256);) this[r + a] = t / i & 255;
                    return r + e
                    ...
                    var i = 0,
                        a = 1,
                        u = 0;
                    for (this[r] = 255 & t; ++i < e && (a *= 256);) t < 0 && 0 === u && 0 !== this[r + i - 1] && (u = 1), this[r + i] = (t / a >> 0) - u & 255;
                    return r + e
                    ...
                    var i = e - 1,
                        a = 1,
                        u = 0;
                    for (this[r + i] = 255 & t; 0 <= --i && (a *= 256);) t < 0 && 0 === u && 0 !== this[r + i + 1] && (u = 1), this[r + i] = (t / a >> 0) - u & 255;
                    return r + e
                    ...
                    if (this === t && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(r, e, n);
                        ...
                        for (var i = o - 1; 0 <= i; --i) t[i + r] = this[i + e];
                    ...
                    if (r >>>= 0, e = void 0 === e ? this.length : e >>> 0, "number" == typeof(t = t || 0))
                        ...
                        var a = c.isBuffer(t) ? t : c.from(t, n),
                            u = a.length;
                ...
                function L(t, r) {
                    for (var e, n, o, i = [], a = 0; a < t.length && !((r -= 2) < 0); ++a) e = t.charCodeAt(a), n = e >> 8, o = e % 256, i.push(o), i.push(n);
                    return i
                }
                ...
                var d = {
                    single_source_shortest_paths: function(t, r, e) {
                        var n = {},
                            o = {};
                        o[r] = 0;
                        var i, a, u, f, s, h, c, l, g = d.PriorityQueue.make();
                        for (g.push(r, 0); !g.empty();)
                            for (u in i = g.pop(), a = i.value, f = i.cost, s = t[a] || {}) s.hasOwnProperty(u) && (h = s[u], c = f + h, l = o[u], (void 0 === o[u] || c < l) && (o[u] = c, g.push(u, c), n[u] = a));
                        if (void 0 === e || void 0 !== o[e]) return n;
                    ...
                    find_path: function(t, r, e) {
                        var n = d.single_source_shortest_paths(t, r, e);
                        return d.extract_shortest_path_from_predecessor_list(n, e)
                    },
                    PriorityQueue: {
                        make: function(t) {
                            var r, e = d.PriorityQueue,
                                n = {};
                            for (r in t = t || {}, e) e.hasOwnProperty(r) && (n[r] = e[r]);
            ...
            32: [function(t, r, e) {
                e.read = function(t, r, e, n, o) {
                    var i, a, u = 8 * o - n - 1,
                        ...
                        l = e ? -1 : 1,
                        g = t[r + c];
                    for (c += l, i = g & (1 << -h) - 1, g >>= -h, h += u; 0 < h; i = 256 * i + t[r + c], c += l, h -= 8);
                    for (a = i & (1 << -h) - 1, i >>= -h, h += n; 0 < h; a = 256 * a + t[r + c], c += l, h -= 8);
                    if (0 === i) i = 1 - s;
                    else {
                    ...
                    var a, u, f, s = 8 * i - o - 1,
                        ...
                        p = n ? 1 : -1,
                        d = r < 0 || 0 === r && 1 / r < 0 ? 1 : 0;
                    for (r = Math.abs(r), isNaN(r) || r === 1 / 0 ? (u = isNaN(r) ? 1 : 0, a = h) : (a = Math.floor(Math.log(r) / Math.LN2), r * (f = Math.pow(2, -a)) < 1 && (a--, f *= 2), 2 <= (r += 1 <= a + c ? l / f : l * Math.pow(2, 1 - c)) * f && (a++, f /= 2), h <= a + c ? (u = 0, a = h) : 1 <= a + c ? (u = (r * f - 1) * Math.pow(2, o), a += c) : (u = r * Math.pow(2, c - 1) * Math.pow(2, o), a = 0)); 8 <= o; t[e + g] = 255 & u, g += p, u /= 256, o -= 8);
                    for (a = a << o | u, s += o; 0 < s; t[e + g] = 255 & a, g += p, a /= 256, s -= 8);
                    t[e + g - p] |= 128 * d
                }
            }, {}],
            33: [function(t, r, e) {
        ...
        methods: {
            generate: function() {
                var e = this,
                    ...
                    r = this.tag,
                    n = String(this.value);
                "canvas" === r ? o.toCanvas(this.$el, n, t, function(t) {
                    if (t) throw t
                }) : "img" === r ? o.toDataURL(n, t, function(t, r) {
                    if (t) throw t;
                    e.$el.src = r
                }) : o.toString(n, t, function(t, r) {
                    if (t) throw t;
                    e.$el.innerHTML = r
                })
            }
